...
class Compra
{
    ...
    public function guardar($proveedor_id, $usuario_id, $factura, $archivoFactura, $productos, $total)
    {
        try {
            $this->conexion->beginTransaction();
            $sql = "INSERT INTO compras
                (proveedor_id,usuario_id,factura_proveedor,archivo_factura,total)
                VALUES
                (:proveedor_id,:usuario_id,:factura,:archivo_factura,:total)";
    ...
    {
        $sql = "SELECT
                c.id,c.fecha,c.total,c.factura_proveedor,c.archivo_factura,
    ...
    {
        $sql = "SELECT c.id, p.nombre proveedor, u.nombre usuario, c.factura_proveedor, c.fecha, c.estado, c.total
            FROM compras c
            INNER JOIN proveedores p ON p.id = c.proveedor_id
            INNER JOIN usuarios u ON u.id = c.usuario_id";
        $stmt = $this->conexion->prepare($sql);
    ...
    {
        $sql = "SELECT
            c.id compra,c.fecha,p.nombre proveedor,pr.codigo,pr.nombre producto,
            dc.cantidad,dc.costo,dc.subtotal,c.estado,u.nombre usuario
