...
class Backup
{
    ...
    {
        $sql = "INSERT INTO respaldos (usuario_id,archivo)
                VALUES (:usuario_id,:archivo)";
    ...
    {
        $sql = "SELECT 
            r.id,r.archivo,r.fecha,u.nombre AS usuario
            FROM respaldos r
            INNER JOIN usuarios uON u.id = r.usuario_id
            ORDER BY r.id DESC";
        return $this->conexion
            ->query($sql)
            ->fetchAll();
