  ...
  function a(e, t) {
    ...
    ((this.s = {
      ...
      this.s.dt.settings()[0].responsive ||
        ...
        (this.c = f.extend(!0, {}, a.defaults, r.defaults.responsive, t)),
        ...
        _detailsDisplay: function (t, n) {
          function e(e) {
            (f(t.node()).toggleClass("parent", !1 !== e),
              f(s.table().node()).triggerHandler("responsive-display.dt", [
                s,
                t,
                e,
                n,
          ...
          display: (a.display = {
            ...
            modal: function (o) {
              return function (e, t, n, i) {
                if (t) {
                  if (
                    !(s = f("div.dtr-modal-content")).length ||
