<div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="page-title mb-0">Usuario</h2>
            ...
            <form id="formUsuario">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            <label class="form-label"><i class="bi bi-envelope-at"></i>Correo</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <select id="rol_id" required class="form-select"></select>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label"><i class="bi bi-camera"></i>Imagen</label>
...
const PUEDE_EDITAR_USUARIOS =
    <?= tienePermiso('usuarios_editar') ? 'true' : 'false' ?>;
const PUEDE_CREAR_USUARIOS =
    <?= tienePermiso('usuarios_crear') ? 'true' : 'false' ?>;
const PUEDE_CAMBIAR_ESTADO_USUARIOS =
    <?= tienePermiso('usuarios_eliminar') ? 'true' : 'false' ?>;
</script>
