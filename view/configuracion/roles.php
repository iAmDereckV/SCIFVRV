<div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="page-title mb-0">Roles</h2>
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label">
                                <i class="bi bi-shield-check"></i>Nombre
                            </label>
...
<div class="table-responsive">
    <table class="table table-hover table-sm align-middle" id="tablaRoles">
        <thead>
            <tr>
                <th>ID</th>
                <th>Nombre</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="d-flex justify-content-end gap-2 mb-3">
                    <button type="button" class="btn btn-outline-success btn-sm" onclick="seleccionarTodos()">
                        <i class="bi bi-check2-square"></i>Seleccionar todos
                    </button>
                    <button type="button" class="btn btn-outline-danger btn-sm" onclick="quitarTodos()">
...
const PUEDE_EDITAR_ROLES =
    <?= tienePermiso('roles_editar') ? 'true' : 'false' ?>;
const PUEDE_CREAR_ROLES =
    <?= tienePermiso('roles_crear') ? 'true' : 'false' ?>;
const PUEDE_CAMBIAR_ESTADO_ROLES =
    <?= tienePermiso('roles_eliminar') ? 'true' : 'false' ?>;
</script>
