<div class="container-fluid">
    <h3 class="page-title mb-4">
        <i class="bi bi-building-fill-gear text-primary"></i>Configuración de la Empresa
    </h3>
    <form id="formEmpresa">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white">
                <h5 class="mb-0">
                    <i class="bi bi-building text-primary"></i>Datos Generales
                </h5>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label">Nombre Empresa
                                </label>
                    ...
                    <div class="col-lg-4">
                        <div class="card border shadow-sm h-100">
                            ...
                            <div class="card-body text-center">
                                <img id="previewLogo" src="" class="img-fluid rounded border mb-3"
