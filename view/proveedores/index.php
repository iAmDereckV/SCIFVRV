<div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="page-title mb-0"> Proveedores </h2>
            ...
            <form id="formProveedor">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="bi bi-box2-heart text-white"></i> Proveedores
                    </h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-building-fill"></i>Nombre </label>
                            <input type="text" id="nombre" required class="form-control"
                                placeholder="Nombre del proveedor">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-person-lines-fill"></i>Contacto</label>
                            <input type="text" id="contacto" required class="form-control"
...
const PUEDE_EDITAR_PROVEEDORES =
    <?= tienePermiso('proveedores_editar') ? 'true' : 'false' ?>;
const PUEDE_CREAR_PROVEEDORES =
    <?= tienePermiso('proveedores_crear') ? 'true' : 'false' ?>;
const PUEDE_CAMBIAR_ESTADO_PROVEEDORES =
    <?= tienePermiso('proveedores_eliminar') ? 'true' : 'false' ?>;
</script>
