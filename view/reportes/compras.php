<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button class="btn btn-success" onclick="exportarExcelCompras()">
...
<div class="card shadow-sm border-0 mb-4">
    <div class="card-body">
        <div class="row align-items-end">
            ...
            <div class="col-md-4">
                <button class="btn btn-primary w-100" onclick="buscarCompras()">
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center">
                ...
                <h3 id="promedioCompra">C$0.00</h3>
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center">
                <small>Compra mayor</small>
                <h3 id="compraMayor">C$0.00</h3>
            </div>
        </div>
    </div>
</div>
...
const PUEDE_CAMBIAR_ESTADO_COMPRAS =
    <?= tienePermiso('compras_anular') ? 'true' : 'false' ?>;
