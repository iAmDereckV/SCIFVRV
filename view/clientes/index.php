<div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="page-title mb-0">Clientes</h2>
            ...
            <form id="formCliente">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="bi bi-people text-white"></i>Cliente
                    </h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">
                                <i class="bi bi-person-vcard-fill"></i>Apellido
                            </label>
                        ...
                        <div class="col-md-4">
                            <label class="form-label">
                                <i class="bi bi-people-fill"></i>Tipo Cliente
                            </label>
                            <select id="tipo_cliente" required class="form-select"></select>
                        </div>
                        <div class="col-md-8">
                            <label class="form-label">
...
<div class="table-responsive">
    <table class="table table-hover table-sm align-middle" id="tablaClientes">
        <thead>
            <tr>
                <th>ID</th>
                <th>Cliente</th>
...
const PUEDE_EDITAR_CLIENTES =
    <?= tienePermiso('clientes_editar') ? 'true' : 'false' ?>;
const PUEDE_CREAR_CLIENTES =
    <?= tienePermiso('clientes_crear') ? 'true' : 'false' ?>;
const PUEDE_CAMBIAR_ESTADO_CLIENTES =
    <?= tienePermiso('clientes_eliminar') ? 'true' : 'false' ?>;
</script>
