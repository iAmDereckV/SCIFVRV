<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
    <div class="container-fluid">
        <div class="d-flex align-items-center">
            <button id="btnMenuOpen" class="btn btn-outline-light me-3 d-lg-none">
            ...
            <a class="navbar-brand d-flex align-items-center" href="#">
                ...
                <div>
                    ...
                    <small class="text-light opacity-75" id="navslogan"></small>
                </div>
            </a>
        </div>
        <div class="d-flex align-items-center">
            <div class="text-end me-3">
                <div class="fw-bold text-white"><?= $_SESSION['nombre'] ?></div>
                <small class="text-light opacity-75"><?= $_SESSION['rol_nombre'] ?></small>
            </div>
