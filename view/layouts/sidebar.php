...
<div class="container-fluid">
    <div class="row">
        <div id="sidebar"
            class="sidebar d-flex flex-column flex-shrink-0 p-3 text-white col-md-2 col-xl-2 col-lg-3 min-vh-100">
            <div>
                <button id="btnMenuClose" class="btn btn-outline-light me-3 d-lg-none">
                    <i class="bi bi-list fs-4"></i>
                </button>
                <img src="" id="navlogo" class="rounded-circle mx-auto d-block shadow" width="85" height="85"
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item ">
                    <a href="index.php" class="nav-link text-white <?= $modulo == 'dashboard' ? 'active' : '' ?>"
                        aria-current="page"><i class="bi bi-speedometer2"></i> Dashboard
                    </a>
                </li>
                <?php endif; ?>
                ...
                <?php endif; ?>
                <?php if (tienePermiso('reportes_ventas') || tienePermiso('reportes_gastos') || tienePermiso('reportes_compras') || tienePermiso('reportes_detalle_maestro') || tienePermiso('excel_exportar')): ?>
                <li>
            ...
            <hr>
            <?php if (tienePermiso('usuarios_ver') || tienePermiso('roles_ver') || tienePermiso('empresa_configurar') || tienePermiso('backup_ver')): ?>
