<div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="page-title mb-0">Productos</h2>
        ...
        <div class="modal-content">
            <form id="formProducto">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="bi bi-box-seam text-white"></i>Producto</h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            <label class="form-label"><i class="bi bi-box-seam-fill"></i>Nombre</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-bookmark-star-fill"></i>Marca</label>
                            <select id="marca_id" required class="form-select"></select>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label"><i class="bi bi-cash-coin"></i>Precio Compra</label>
                            <input type="number" required step="0.01" id="precio_compra" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label"> <i class="bi bi-currency-dollar"></i>Precio Venta</label>
                            <input type="number" required step="0.01" id="precio_venta" class="form-control">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label"><i class="bi bi-geo-alt-fill"></i>Ubicación</label>
                            <input type="text" id="ubicacion" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-boxes"></i>Stock</label>
                            <input type="number" id="stock" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">
                                <i class="bi bi-exclamation-triangle-fill"></i>Stock mínimo
                            </label>
                            <input type="number" id="stock_minimo" required class="form-control">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">
                                <i class="bi bi-car-front-fill"></i>Vehículo aplicable
                            </label>
                        ...
                        <div class="col-md-12">
                            <label class="form-label"><i class="bi bi-image-fill"></i>Imagen</label>
...
<div class="modal fade" id="modalDetalleProducto" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="bi bi-box-seam me-2"></i>Información del Producto</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                        <img id="detalleImagen" src="" class="img-fluid rounded shadow border p-2 bg-white"
                    ...
                    <div class="col-md-8">
                        <table class="table table-borderless table-sm align-middle mb-0">
                            <tbody>
                                <tr>
                                    <th width="35%"><i class="bi bi-upc-scan"></i>Código</th>
                                ...
                                <tr>
                                    <th><i class="bi bi-bookmark-star"></i>Marca</th>
                                    <td id="detalleMarca"></td>
                                </tr>
                                <tr>
                                    <th><i class="bi bi-cash-coin"></i>Precio Compra</th>
                                    <td id="detalleCosto"></td>
                                </tr>
                                <tr>
                                    <th><i class="bi bi-currency-dollar"></i>Precio Venta</th>
                                ...
                                <tr>
                                    <th><i class="bi bi-exclamation-triangle"></i>Stock Mínimo</th>
                                ...
                                <tr>
                                    <th><i class="bi bi-car-front"></i>Vehículo Aplicable</th>
                ...
                <hr>
                <div>
                    <h6 class="fw-bold"><i class="bi bi-card-text"></i>Descripción</h6>
...
const PUEDE_EDITAR_PRODUCTOS =
    <?= tienePermiso('productos_editar') ? 'true' : 'false' ?>;
const PUEDE_CREAR_PRODUCTOS =
    <?= tienePermiso('productos_crear') ? 'true' : 'false' ?>;
const PUEDE_CAMBIAR_ESTADO_PRODUCTOS =
    <?= tienePermiso('productos_eliminar') ? 'true' : 'false' ?>;
</script>
