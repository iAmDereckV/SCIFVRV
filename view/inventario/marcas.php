<div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="page-title mb-0">Marcas</h2>
            ...
            <form id="formMarca">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="bi bi-bookmark-star text-white"></i>Marca
                    </h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label"><i class="bi bi-bookmark-star-fill"></i>Nombre</label>
...
const PUEDE_EDITAR_MARCAS =
    <?= tienePermiso('marcas_editar') ? 'true' : 'false' ?>;
const PUEDE_CREAR_MARCAS =
    <?= tienePermiso('marcas_crear') ? 'true' : 'false' ?>;
const PUEDE_CAMBIAR_ESTADO_MARCAS =
    <?= tienePermiso('marcas_eliminar') ? 'true' : 'false' ?>;
</script>
