<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <button class="btn btn-primary" onclick="nuevoCategoria()">
        <i class="bi bi-plus-circle"></i>Nuevo Categoría
    </button>
</div>
            ...
            <form id="formCategoria">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="bi bi-tags text-white"></i>Categoría
                    </h5>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label"><i class="bi bi-tags-fill"></i>Nombre</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle"></i>Guardar Categoria
                    </button>
                </div>
            </form>
        </div>
...
const PUEDE_EDITAR_CATEGORIAS =
    <?= tienePermiso('categorias_editar') ? 'true' : 'false' ?>;
const PUEDE_CREAR_CATEGORIAS =
    <?= tienePermiso('categorias_crear') ? 'true' : 'false' ?>;
const PUEDE_CAMBIAR_ESTADO_CATEGORIAS =
    <?= tienePermiso('categorias_eliminar') ? 'true' : 'false' ?>;
</script>
